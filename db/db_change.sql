...
CREATE TABLE `novel_history` (
  ...
  `last_novel_id` varchar(36) DEFAULT NULL COMMENT '最后访问小说id',
  `last_volume_id` varchar(36) DEFAULT NULL COMMENT '最后访问的分卷id',
  `last_chapter_id` varchar(36) DEFAULT NULL COMMENT '最后访问的章节id',
